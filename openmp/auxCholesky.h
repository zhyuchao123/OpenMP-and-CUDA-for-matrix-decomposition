...
// post: prints out a; 
void printIntTile(int wT, int **a);
...
// pre: A has storage for a nT x nT array of (double*), nT=(N+wT-1)/wT
// post: A[][] holds an nT x nT tiled +ve definite lower tri. matrix, t
//       tile size of wT
